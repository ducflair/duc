...
export const selectGroupsForSelectedElements = (function () {
  ...
  let lastSelectedElements: readonly NonDeleted<DucElement>[] | null =
    null;
  let lastElements: readonly NonDeleted<DucElement>[] | null = null;
  let lastReturnValue: SelectGroupsReturnType | null = null;

  const _selectGroups = (
    selectedElements: readonly NonDeleted<DucElement>[],
    elements: readonly NonDeleted<DucElement>[],
...
export const isElementInGroup = (element: DucElement, groupId: string) =>
...
export const getElementsInGroup = (
  ...
  const elementsInGroup: DucElement[] = [];
...
export const addToGroup = (
  prevGroupIds: DucElement["groupIds"],
  newGroupId: GroupId,
  editingGroupId: AppState["editingGroupId"],
) => {
...
export const getMaximumGroups = (
  ...
  const groups: Map<String, DucElement[]> = new Map<
    String,
    DucElement[]
  >();
  elements.forEach((element: DucElement) => {
    const groupId =
...
export const elementsAreInSameGroup = (elements: DucElement[]) => {
