...
const duplicateElements = (
  ...
  // loop over them.
  const processedIds = new Map<DucElement["id"], true>();

  const markAsProcessed = (elements: DucElement[]) => {
  ...
  const elementsWithClones: DucElement[] = [];
  ...
  const finalElementsReversed: DucElement[] = [];

  const finalElementIds = new Map<DucElement["id"], true>();
