...
static addPreviousSelectedElementIds(builder:flatbuffers.Builder, previousSelectedElementIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(49, previousSelectedElementIdsOffset, 0);
}
