...
export const redrawTextBoundingBox = (
  ...
  if (container) {
    const maxContainerHeight = getBoundTextMaxHeight(
      container,
      textElement as DucTextElementWithContainer,
    );
...
export const bindTextToShapeAfterDuplication = (
  newElements: DucElement[],
  oldElements: DucElement[],
...
export const handleBindTextResize = (
  container: NonDeletedDucElement,
  elementsMap: ElementsMap,
...
export const detectLineHeight = (textElement: DucTextElement) => {
  ...
  return (textElement.height /
    lineCount /
    textElement.fontSize) as DucTextElement["lineHeight"];
};
...
const DEFAULT_LINE_HEIGHT = {
  ...
  // Gecko (FF) uses ~1.28.
  [FONT_FAMILY.Virgil]: 1.25 as DucTextElement["lineHeight"],
  // ~1.15 is the average for Helvetica in WebKit and Blink.
  [FONT_FAMILY.Helvetica]: 1.15 as DucTextElement["lineHeight"],
  // ~1.2 is the average for Cascadia in WebKit and Blink, and kinda Gecko too
  [FONT_FAMILY.Cascadia]: 1.2 as DucTextElement["lineHeight"],
};
