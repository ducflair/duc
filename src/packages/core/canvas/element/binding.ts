...
export const updateBoundElements = (
  ...
  getNonDeletedElements(
    ...
    const bindableElement = changedElement as DucBindableElement;
    ...
    updateBoundPoint(
      ...
      "start",
      startBinding,
      changedElement as DucBindableElement,
      elementsMap,
    );
    updateBoundPoint(
      element,
...
export const fixBindingsAfterDeletion = (
  ...
  const affectedElements: Set<DucElement["id"]> = new Set();
...
const newBindingAfterDeletion = (
  binding: PointBinding | null,
  deletedElementIds: Set<DucElement["id"]>,
): PointBinding | null => {
