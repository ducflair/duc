...
static createDucRectangleElement(builder:flatbuffers.Builder, baseOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset):flatbuffers.Offset {
  DucRectangleElement.startDucRectangleElement(builder);
  DucRectangleElement.addBase(builder, baseOffset);
  DucRectangleElement.addType(builder, typeOffset);
