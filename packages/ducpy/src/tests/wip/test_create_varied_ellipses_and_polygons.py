...
from packages.ducpy.src.ducpy.classes.ElementsClass import DucEllipseElement, DucPolygonElement, ElementBackground, ElementStroke, ElementContentBase, StrokeStyleProps
