      ...
      elements: elements.map((element) => {
        if (selectedElementIds.includes(element.id)) {
          ...
          if (isTextElement(newElement)) {
            const fontSize =
              (elementStylesToCopyFrom as DucTextElement).fontSize ||
              DEFAULT_FONT_SIZE;
            const fontFamily =
              (elementStylesToCopyFrom as DucTextElement).fontFamily ||
              DEFAULT_FONT_FAMILY;
            newElement = newElementWith(newElement, {
              fontSize,
              fontFamily,
              textAlign:
                (elementStylesToCopyFrom as DucTextElement).textAlign ||
                DEFAULT_TEXT_ALIGN,
              lineHeight:
