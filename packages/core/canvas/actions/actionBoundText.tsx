  ...
  perform: (elements, appState, _, app) => {
    ...
    selectedElements.forEach((element) => {
      ...
      if (boundTextElement) {
        ...
        mutateElement(boundTextElement as DucTextElement, {
          containerId: null,
          width,
          height,
...
export const actionBindText = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    let textElement: DucTextElement;
    let container: DucTextContainer;
    ...
    if (
      ...
      textElement = selectedElements[1] as DucTextElement;
      container = selectedElements[0] as DucTextContainer;
    }
