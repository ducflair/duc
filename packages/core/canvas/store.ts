...
import type { OrderedDucElement } from "./element/types";
...
export interface IStore {
   ...
   */
  commit(
    elements: Map<string, OrderedDucElement> | undefined,
  ...
  filterUncomittedElements(
    prevElements: Map<string, OrderedDucElement>,
    nextElements: Map<string, OrderedDucElement>,
  ): Map<string, OrderedDucElement>;
}
...
export class Snapshot {
  private constructor(
    public readonly elements: Map<string, OrderedDucElement>,
