...
const truncateText = (element: DucTextElement, maxWidth: number) => {
...
const addFrameLabelsAsTextElements = (
  ...
  const nextElements: NonDeletedDucElement[] = [];
...
const prepareElementsForRender = ({
  ...
  exportingFrame: DucFrameLikeElement | null | undefined;
  frameRendering: AppState["frameRendering"];
  exportWithDarkMode: AppState["exportWithDarkMode"];
}) => {
  let nextElements: readonly DucElement[];
