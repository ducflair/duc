...
function parseFreeDrawElement(element: DucFreeDrawElementFb): DucFreeDrawElement {
  ...
  return {
    ...
    easing: element.easing()! as unknown as DucFreeDrawEasing,
    start: start ? { cap: start.cap(), taper: start.taper(), easing: start.easing()! as unknown as DucFreeDrawEasing } : null,
    end: end ? { cap: end.cap(), taper: end.taper(), easing: end.easing()! as unknown as DucFreeDrawEasing } : null,
