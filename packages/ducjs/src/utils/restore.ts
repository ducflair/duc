...
import type { MarkOptional, Mutable, ValueOf } from "ducjs/types/utility-types";
import {
  arrayToMap,
  getUpdatedTimestamp,
  isFiniteNumber,
...
} from "ducjs/utils/elements";
import { getNormalizedPoints, mergeOverlappingPoints, validateClosedPath } from "ducjs/utils/elements/linearElement";
