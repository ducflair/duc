...
deletedElementIds(index: number,optionalEncoding?:any):string|Uint8Array|null {
...
static startRendererState(builder:flatbuffers.Builder) {
  builder.startObject(1);
}

static addDeletedElementIds(builder:flatbuffers.Builder, deletedElementIdsOffset:flatbuffers.Offset) {
...
static startDeletedElementIdsVector(builder:flatbuffers.Builder, numElems:number) {
