...
impl PdfLineHeadRenderer {
    ...
    pub fn render_line_head(
        ...
        let base_offset = match head_type {
            ...
            LINE_HEAD::REVERSED_TRIANGLE | LINE_HEAD::REVERSED_TRIANGLE_OUTLINED => -2.8 * line_width,
    ...
    fn render_head_shape(head_type: LINE_HEAD, line_width: f64) -> ConversionResult<Vec<Operation>> {
        let mut ops = Vec::new();
    ...
    fn create_circle(cx: f64, cy: f64, radius: f64, filled: bool) -> ConversionResult<Vec<Operation>> {
        let mut ops = Vec::new();
