...
Typst source selects fonts by exact family name. See [Using Fonts](/docs/guidelines/using-fonts#document-elements) for family declarations, fallback chains, Scopture's font resolution behavior, and local CLI testing.
